...
public class GetStepApiController {
    ...
    public ResponseEntity<List<String>> getEnigmaFromAllApis() {
        ...
        String responseFromApi1 = makeGetRequest("http://localhost:8080/v1/getOneEnigma/getStepString");
        enigmaResponses.add(responseFromApi1);

        // Llamada a la segunda API
        String responseFromApi2 = makeGetRequest("http://localhost:8081/v1/getOneEnigma/getStepString");
        enigmaResponses.add(responseFromApi2);

        // Llamada a la tercera API
        String responseFromApi3 = makeGetRequest("http://localhost:8082/v1/getOneEnigma/getStepString");
